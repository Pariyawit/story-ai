                ...
                <div className='grid grid-cols-6 gap-2'>
                    {hairColorOptions.map(({ id, emoji, labelEn, labelTh }) => (
                        <button
                            ...
                            className={`flex items-center justify-center rounded-xl p-2 text-xl transition-all ${character.hairColor === id
                ...
                <div className='grid grid-cols-5 gap-2'>
                    {hairStyleOptions.map(({ id, emoji, labelEn, labelTh }) => (
                        <button
                            ...
                            className={`flex flex-col items-center rounded-xl border-2 p-2 transition-all ${character.hairStyle === id
                ...
                <div className='grid grid-cols-5 gap-2'>
                    {outfitStyleOptions.map(({ id, emoji, labelEn, labelTh }) => (
                        <button
                            ...
                            className={`flex flex-col items-center rounded-xl border-2 p-2 transition-all ${character.outfitStyle === id
                                    ? 'border-purple-400 bg-gradient-to-br from-purple-100 to-pink-100 shadow-md'
                                    : 'border-purple-200 bg-white/70 hover:border-purple-300 hover:bg-white'
                                }`}
                        >
                ...
                <div className='grid grid-cols-6 gap-2'>
                    {favoriteColorOptions.map(({ id, emoji, labelEn, labelTh }) => (
                        <button
                            ...
                            title={language === 'th' ? labelTh : labelEn}
                            className={`flex items-center justify-center rounded-xl p-2 text-xl transition-all ${character.favoriteColor === id
                                    ? 'scale-110 bg-purple-500 shadow-lg ring-2 ring-purple-400 ring-offset-1'
                                    : 'bg-white/70 hover:bg-white hover:shadow-md'
                                }`}
                        >
