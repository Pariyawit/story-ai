...
export const metadata: Metadata = {
  ...
  description: "An AI-powered interactive storytelling app for kids. Follow the Hero's Journey through 12 magical story beats with beautiful watercolor illustrations and make choices that shape your adventure.",
